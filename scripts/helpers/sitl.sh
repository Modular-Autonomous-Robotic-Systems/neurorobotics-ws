...
setup_airsim_ros_pkgs_for_docker_build() {
    ...
    iexec init_container "mkdir -p /ws/docker/$directory/airsim_ws/src/AirSim && \
		...
		/ws/docker/$directory/airsim_ws/src/AirSim/ && \
		echo \"here\" && \
		ls /ws/docker/$directory/airsim_ws/src/AirSim/"
}
